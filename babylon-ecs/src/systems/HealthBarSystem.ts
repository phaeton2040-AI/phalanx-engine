...
export class HealthBarSystem {
    ...
    constructor(
        ...
        this.guiTexture = AdvancedDynamicTexture.CreateFullscreenUI("healthBarUI", true, this.scene);
     ...
     */
    private updateHealthBar(entityId: number, currentHealth: number, maxHealth: number): void {
     ...
     */
    private updateHealthBarColor(healthBar: HealthBar, healthPercent: number): void {
     ...
     */
    private updateHealthBarVisibility(healthBar: HealthBar, healthPercent: number): void {
