...
export class FormationHoverPreview {
    ...
    public showHoverHighlight(
        ...
        this.hoverHighlight.material = isValid ? this.hoverHighlightMaterial : this.invalidHighlightMaterial;
     ...
     */
    private showHoverUnitPreview(worldPos: Vector3, unitType: FormationUnitType, team: TeamTag): void {
        ...
        const teamColor = team === TeamTag.Team1
    ...
    private createHoverSpherePreview(teamColor: Color3): Mesh {
        ...
        const material = new StandardMaterial("hoverUnitPreviewMat_sphere", this.scene);
    ...
    private createHoverLancePreview(teamColor: Color3, team: TeamTag): Mesh {
        ...
        const crystalMaterial = new StandardMaterial("hoverLanceCrystalMat", this.scene);
        crystalMaterial.diffuseColor = teamColor;
        crystalMaterial.emissiveColor = teamColor.scale(0.2);
        crystalMaterial.alpha = 0.5;
        crystal.material = crystalMaterial;
