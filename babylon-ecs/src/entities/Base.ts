...
export class Base extends Entity {
    ...
    constructor(scene: Scene, config: BaseConfig, position: Vector3 = new Vector3(0, 0, 0)) {
        super(scene);
    ...
    private createRangeIndicator(): void {
        ...
        const material = new StandardMaterial(`baseRangeMat_${this.id}`, this.scene);
