...
export class ModelLoader {
     ...
     */
    public async loadAndCacheModel(url: string, cacheKey: string): Promise<LoadedModel> {
     ...
     */
    public cloneCachedModel(cacheKey: string, instanceName: string): LoadedModel | null {
     ...
     */
    public static getAnimationByName(model: LoadedModel, name: string): AnimationGroup | undefined {
