 ...
 */
export function hasDeathSequence(
  entity: Entity
): entity is Entity & IDeathSequence {
  return 'isDying' in entity && 'startDeathSequence' in entity;
}
